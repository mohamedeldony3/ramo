...
Ramo = Token:match("(%d+)")
redis:mset(
Ramo..":VERSION",GetUser.information.Source_version,
Ramo..":SUDO_ID:",GetUser.information.id,
Ramo..":DataCenter:",GetUser.information.DataCenter,
Ramo..":UserNameBot:",BOT_User,
Ramo..":ApiSource",GetUser.information.WebSite,
Ramo..":NameBot:","ساره",
"T_O_Y_S_INSTALL","Yes"
)
redis:hset(Ramo..'username:'..GetUser.information.id,'username','@'..GetUser.information.username:gsub('_',[[\_]]))
info = {}
...
Ramo = Token:match("(%d+)")
our_id = tonumber(Ramo)
ApiRamo = redis:get(Ramo..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(Ramo..":UserNameBot:")
SUDO_ID = tonumber(redis:get(Ramo..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(Ramo..'username:'..SUDO_ID).username
version = redis:get(Ramo..":VERSION")
DataCenter = redis:get(Ramo..":DataCenter:")
...
..'꒐ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..Ramo..')\027[0;32m\n'
...
..'꒐ Api_Src->: \27[1;34m'..ApiRamo..'\027[0;32m\n'
...
if not redis:get(Ramo..":Check_Bot:"..W) then
Rgz,res=https.request(ApiRamo..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(Ramo..":Check_Bot:"..W,1800,true) return false else return Rgz end
end
end
...
if msg.type == "pv" and redis:get(Ramo..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false
end
if msg.type ~= "pv" and redis:get(Ramo..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(Ramo..'group:add'..msg.chat_id_) then
...
and redis:get(Ramo.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(Ramo..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(Ramo..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(Ramo..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)
end
...
if not redis:get(Ramo..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(Ramo..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(Ramo..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false
end
...
msg.TheRankCmd = redis:get(Ramo..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي'
msg.TheRank = redis:get(Ramo..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️'
msg.Rank = 1
elseif redis:sismember(Ramo..':SUDO_BOT:',msg.sender_user_id_) then
msg.TheRankCmd = redis:get(Ramo..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(Ramo..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(Ramo..':Malk_Group:'..msg.chat_id_,msg.sender_user_id_) then
msg.TheRankCmd = redis:get(Ramo..":RtbaNew8:"..msg.chat_id_) or 'مالك'
msg.TheRank = redis:get(Ramo..":RtbaNew8:"..msg.chat_id_) or 'مالك 👲🏼'
msg.Rank = 22
elseif msg.GroupActive and redis:sismember(Ramo..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then
msg.TheRankCmd = redis:get(Ramo..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(Ramo..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(Ramo..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then
msg.TheRankCmd = redis:get(Ramo..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(Ramo..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(Ramo..'owners:'..msg.chat_id_,msg.sender_user_id_) then
msg.TheRankCmd = redis:get(Ramo..":RtbaNew5:"..msg.chat_id_) or 'المدير'
msg.TheRank = redis:get(Ramo..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️'
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(Ramo..'admins:'..msg.chat_id_,msg.sender_user_id_) then
msg.TheRankCmd = redis:get(Ramo..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(Ramo..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(Ramo..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then
msg.TheRank = redis:get(Ramo..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(Ramo..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(Ramo..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(Ramo..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(Ramo..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(Ramo..':WELCOME_BOT'),[[- مـرحبا انا بوت اسـمـي ]]..redis:get(Ramo..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(Ramo.."lock_Add"..msg.chat_id_) then
...
if redis:get(Ramo.."lock_check"..msg.chat_id_) and not redis:get(Ramo..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(Ramo..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(Ramo..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(Ramo..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.Ramo then
if msg.text and ScriptFile.iRamo then
XRamo = ScriptFile.Ramo
local list = redis:hgetall(Ramo..":AwamerBotArray:"..msg.chat_id_)
for Ramo2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(Ramo2) then
local amrr = {Text:match(Ramo2)}
local AmrOld = redis:hgetall(Ramo..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.iRamo(msg,{Text:match(Text2)})
if GetMsg then
...
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(Ramo) then -- Check Commands To admin
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end
GetMsg = ScriptFile.iRamo(msg,{Text:match(Ramo)})
if GetMsg then
print("\27[1;35m꒐This_Msg : ",Ramo.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end
end
...
if ScriptFile.dRamo then
if ScriptFile.dRamo(msg) == false then
return false
end
...
if Plug.Ramo then
if msg.text and Plug.iRamo then
for k, Ramo in pairs(Plug.Ramo) do
if msg.text:match(Ramo) then
local GetMsg = Plug.iRamo(msg,{msg.text:match(Ramo)})
if GetMsg then
print("\27[1;35m꒐This_Msg : ",Ramo.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end
return false
end
...
print("The File "..name.." Not Runing in The Source Ramo")
end

end
else
print("The File Script.lua Not Runing in The Source Ramo")
end
end
...
redis:srem(Ramo..'users',msg.sender_user_id_)
end
...
if redis:get(Ramo..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(Ramo..":propin"..msg.chat_id_)
...
if redis:get(Ramo..'group:add'..data.chat_.id_) then
redis:set(Ramo..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then
if data.channel_.status_.ID == "ChatMemberStatusKicked" then
if redis:get(Ramo..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(Ramo..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(Ramo..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
Ramo..'group:name'..k,IDS.Title,
Ramo..'num_msg_max'..k,5,
Ramo..'group:add'..k,true,
Ramo..'lock_link'..k,true,
Ramo..'lock_spam'..k,true,
Ramo..'lock_webpage'..k,true,
Ramo..'lock_markdown'..k,true,
Ramo..'lock_flood'..k,true,
Ramo..'lock_bots'..k,true,
Ramo..'mute_forward'..k,true,
Ramo..'mute_contact'..k,true,
Ramo..'mute_document'..k,true,
Ramo..'mute_inline'..k,true,
Ramo..'lock_username'..k,true,
Ramo..'replay'..k,true
)
redis:sadd(Ramo..'group:ids',k)

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(Ramo..'username:'..ID,'username',user)
redis:sadd(Ramo..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(Ramo..'username:'..ID,'username',user)
redis:sadd(Ramo..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(Ramo..'username:'..ID,'username',user)
redis:sadd(Ramo..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'-تم رفع النسـخة‏‏ الاحتياطـية\n- حاليا عدد مـجمـوعاتگ ة‏‏ية‏‏ *'..redis:scard(Ramo..'group:ids')..'* ✓')
end
elseif data.ID == "UpdateUser" then
if data.user_.type_.ID == "UserTypeDeleted" then
print("꒐ userTypeDeleted")
redis:srem(Ramo..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(Ramo..'username:'..data.user_.id_).username
...
redis:hset(Ramo..'username:'..data.user_.id_,'username',USERNAME)
end
end
