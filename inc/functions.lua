...
print(CmdSitting)
if CmdSitting then
local ResRedis =  redis:del(ramo..CmdSitting..msg.chat_id_)
...
if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"ليس لديك صلاحية التحكم الادمن , ارجو المعذرة ❤️",true) end
if ResRedis == 0 then redis:set(ramo..CmdSitting..msg.chat_id_,true) end
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " التعديل » '..(redis:get(ramo..'lock_edit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_edit"},'
..'{"text": " الروابط » '..(redis:get(ramo..'lock_link'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_link"}],'

..'[{"text": " التاك » '..(redis:get(ramo..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_tag"},'
..'{"text": " المعرفات » '..(redis:get(ramo..'lock_username'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_username"}],'

..'[{"text": " التكرار » '..(redis:get(ramo..'lock_flood'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_flood"},'
..'{"text": " الكلايش » '..(redis:get(ramo..'lock_spam'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_spam"}],'

..'[{"text": " الويب » '..(redis:get(ramo..'lock_webpage'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_webpage"},'
..'{"text": " الماركدوان » '..(redis:get(ramo..'lock_markdown'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_markdown"}],'

..'[{"text": " البوتات بالطرد » '..(redis:get(ramo..'lock_bots_by_kick'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots_by_kick"},'
..'{"text": " البوتات » '..(redis:get(ramo..'lock_bots'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_bots"}],'

..'[{"text": " الاضافه » '..(redis:get(ramo..'lock_Add'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_Add"},'
..'{"text": " الاشعارات » '..(redis:get(ramo..'mute_tgservice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_tgservice"}],'

..'[{"text": " الفشار » '..(redis:get(ramo..'lock_mmno3'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_mmno3"},'
..'{"text": " الفارسيه » '..(redis:get(ramo..'lock_pharsi'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_pharsi"}],'

..'[{"text": " الانكليزيه » '..(redis:get(ramo..'lock_lang'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#lock_lang"},'
..'{"text": " التوجيه » '..(redis:get(ramo..'mute_forward'..msg.chat_id_) or 'false')..'","callback_data": "Sitting1#mute_forward"}],'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " المتحركه » '..(redis:get(ramo..'mute_gif'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_gif"},'
..'{"text": " الدردشه » '..(redis:get(ramo..'mute_text'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_text"}],'

..'[{"text": " الانلاين » '..(redis:get(ramo..'mute_inline'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_inline"},'
..'{"text": " الالعاب » '..(redis:get(ramo..'mute_game'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_game"}],'

..'[{"text": " الصور » '..(redis:get(ramo..'mute_photo'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_photo"},'
..'{"text": " الفيديو » '..(redis:get(ramo..'mute_video'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_video"}],'

..'[{"text": " الصوت » '..(redis:get(ramo..'mute_audio'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_audio"},'
..'{"text": " البصمات » '..(redis:get(ramo..'mute_voice'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_voice"}],'

..'[{"text": " الملصقات » '..(redis:get(ramo..'mute_sticker'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_sticker"},'
..'{"text": " الجهات » '..(redis:get(ramo..'mute_contact'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_contact"}],'

..'[{"text": " الموقع » '..(redis:get(ramo..'mute_location'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_location"},'
..'{"text": " الملفات » '..(redis:get(ramo..'mute_document'..msg.chat_id_) or 'false')..'","callback_data": "Sitting2#mute_document"}],'
..'[{"text": "- رجوع » ","callback_data": "CmdBack1"},{"text": "- اخفاء الامر","callback_data": "LoginOut"}]'
...
list_settings = '{"inline_keyboard": ['
..'[{"text": " الايدي » '..(redis:get(ramo..'lock_id'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_id"},'
..'{"text": " التاك للكل » '..(redis:get(ramo..'lock_takkl'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_takkl"}],'

..'[{"text": " الترحيب » '..(redis:get(ramo..'welcome:get'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#welcome:get"},'
..'{"text": " الردود » '..(redis:get(ramo..'replay'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#replay"}],'

..'[{"text": " الردود العشوائيه » '..(redis:get(ramo..'lock_tag'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_tag"},'
..'{"text": " التحذير » '..(redis:get(ramo..'lock_woring'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_woring"}],'

..'[{"text": " تاك » '..(redis:get(ramo..'lock_RandomRdod'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_RandomRdod"},'
..'{"text": " الرابط » '..(redis:get(ramo..'lock_linkk'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_linkk"}],'

..'[{"text": " المغادره » '..(redis:get(ramo..'lock_leftgroup'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_leftgroup"},'
..'{"text": " الحظر » '..(redis:get(ramo..'lock_KickBan'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_KickBan"}],'

..'[{"text": " الحمايه » '..(redis:get(ramo..'antiedit'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#antiedit"},'
..'{"text": " الايدي بالصوره » '..(redis:get(ramo..'idphoto'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#idphoto"}],'

..'[{"text": " التحقق » '..(redis:get(ramo..'lock_check'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_check"},'
..'{"text": " التنظيف التلقائي » '..(redis:get(ramo..'lock_cleaner'..msg.chat_id_) or 'false')..'","callback_data": "Sitting3#lock_cleaner"}],'
...
Adminn = true
elseif redis:sismember(ramo..':SUDO_BOT:',msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramo..':Malk_Group:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramo..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramo..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramo..'owners:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
elseif redis:sismember(ramo..'admins:'..msg.chat_id_,msg.sender_user_id_) then
Adminn = true
end
return Adminn
end
...
download_file('https://raw.githubusercontent.com/mohamedeldony3/ramo/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/mohamedeldony3/ramo/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/mohamedeldony3/ramo/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/mohamedeldony3/ramo/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝-* تم تحديث السورس الى اصدار *v'..redis:get(ramo..":VERSION")..'*\n📟-* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ramo..":NameBot:") or "ساره"
...
usernn = data.username_ or "mohamedeldony3"
else
Name = data.title_
usernn = data.type_.user_.username_ or "mohamedeldony3"
end
Name = Name:gsub('[[][]]','')
...
Fshar_Word , res = https.request('https://api.Ramo41.com/Words_Fshars.txt')
...
var = redis:get(ramo..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️'
elseif redis:sismember(ramo..':SUDO_BOT:',UserID) then
var = redis:get(ramo..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻'
elseif redis:sismember(ramo..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(ramo..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽'
elseif redis:sismember(ramo..':Malk_Group:'..ChatID,UserID) then
var = redis:get(ramo..":RtbaNew8:"..ChatID) or ' المالك 👷🏽'
elseif redis:sismember(ramo..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(ramo..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽'
elseif redis:sismember(ramo..'owners:'..ChatID,UserID) then
var = redis:get(ramo..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️'
elseif redis:sismember(ramo..'admins:'..ChatID,UserID) then
var = redis:get(ramo..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓'
elseif redis:sismember(ramo..'whitelist:'..ChatID,UserID) then
var = redis:get(ramo..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️'
else
var = 'فقط عضو 🙍🏼‍♂️'
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(ramo..':NameBot:'))
...
if msg.edited then
redis:incr(ramo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(ramo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then
redis:incr(ramo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(ramo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(ramo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(ramo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(ramo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(ramo..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(ramo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(ramo..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(ramo..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(ramo..'owners:'..msg.chat_id_)
local Admins = redis:smembers(ramo..'admins:'..msg.chat_id_)
local mmez = redis:smembers(ramo..'whitelist:'..msg.chat_id_)
...
message = message ..i.. '-l ['..info.username..'](t.me/mohamedeldony3) \n'
end
...
local list = redis:smembers(ramo..':SUDO_BOT:')
message = '- قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(ramo..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا  *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(ramo..'username:'..v)
local count = redis:scard(ramo..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](t.me/mohamedeldony3) l » (`' ..v.. '`){'..count..'} \n'
end
end
end
...
message = message ..k.. '-l ['..info.username..'](t.me/mohamedeldony3) l » (`' ..v.. '`) \n'
end
end
end
...
local list = redis:smembers(ramo..'owners:'..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(ramo..':Malk_Group:'..msg.chat_id_)
if #list == 0 then
...
local list = redis:smembers(ramo..'admins:'..msg.chat_id_)
...
local list = redis:smembers(ramo..'whitelist:'..msg.chat_id_)
...
if redis:sismember(ramo..'is_silent_users:'..Group,User) then
return true
else
return false
end
...
local res = https.request("http://api.Ramo41.com/CheckUser/?User="..User)
if res == "false" then return true else return false end
end


function MuteUser_list(msg)
local list = redis:smembers(ramo..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(ramo..'banned:'..Group,User) then
return true
else
return false
end
...
local list = redis:smembers(ramo..'bannedpv')
if #list==0 then return "- قائمة المحظورين فارغة " end
message = '-قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
local info = redis:hgetall(ramo..'username:'..v)
...
if redis:sismember(ramo..'gban_users',User) then
return true
else
return false
end
...
local list = redis:smembers(ramo..'gban_users')
...
local list = redis:smembers(ramo..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(ramo..':Filter_Word:'..msg.chat_id_,word) then
return  "- الكلمه *{"..word.."}* هي بالتاكيد من قائمه المنع."
else
redis:sadd(ramo..':Filter_Word:'..msg.chat_id_,word)
...
if redis:sismember(ramo..':Filter_Word:'..msg.chat_id_,word) then
redis:srem(ramo..':Filter_Word:'..msg.chat_id_,word)
...
local NumberFlood = tonumber(redis:get(ramo..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then
result = false
else
redis:setex(ramo..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..ramo..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(ramo..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(ramo..'group:name'..GroupS) or '')
...
local admins = redis:smembers(ramo..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(ramo..'username:'..value)
if info then
...
local creator = redis:smembers(ramo..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(ramo..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(ramo..'group:ids')
message = '-قائمه المجموعات :\n\n'
for k,v in pairs(list) do
local info = redis:get(ramo..'group:name'..v)
if info then
...
redis:del(
ramo..'group:add'..id_group,
ramo..'lock_link'..id_group,
ramo..'lock_id'..id_group,
ramo..'lock_spam'..id_group,
ramo..'lock_webpage'..id_group,
ramo..'lock_markdown'..id_group,
ramo..'lock_flood'..id_group,
ramo..'lock_bots'..id_group,
ramo..'mute_forward'..id_group,
ramo..'mute_contact'..id_group,
ramo..'mute_location'..id_group,
ramo..'mute_document'..id_group,
ramo..'mute_keyboard'..id_group,
ramo..'mute_game'..id_group,
ramo..'mute_inline'..id_group,
ramo..'lock_username'..id_group,
ramo..'num_msg_max'..id_group,
ramo..'mute_text'..id_group,
ramo..'admins:'..id_group,
ramo..':Filter_Word:'..id_group,
ramo..'banned:'..id_group,
ramo..'is_silent_users:'..id_group,
ramo..'whitelist:'..id_group,
ramo..':MONSHA_BOT:'..id_group,
ramo..'owners:'..id_group,
ramo..'replay'..id_group,
ramo..':MONSHA_Group:'..id_group,
ramo..':Malk_Group:'..id_group
)
redis:srem(ramo..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(ramo..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(ramo..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(ramo..'admins:'..arg.chat_id_,data.id_)
...
function modadd(msg)
if redis:get(ramo..'lock_service') then
lock_servicez = true
else
lock_servicez = false
end
...
if redis:get(ramo..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'- المجموعه بالتاكيد ✓️ تم تفعيلها \n- بواسطه ⋙「 '..NameUser..' 」 \n') end
...
local GroupUsers = tonumber(redis:get(ramo..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(ramo..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(ramo..':Malk_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
ramo..'group:add'..arg.chat_id_,true,
ramo..'lock_link'..arg.chat_id_,true,
ramo..'lock_id'..arg.chat_id_,true,
ramo..'lock_spam'..arg.chat_id_,true,
ramo..'lock_webpage'..arg.chat_id_,true,
ramo..'lock_markdown'..arg.chat_id_,true,
ramo..'lock_flood'..arg.chat_id_,true,
ramo..'lock_bots'..arg.chat_id_,true,
ramo..'mute_forward'..arg.chat_id_,true,
ramo..'mute_contact'..arg.chat_id_,true,
ramo..'mute_location'..arg.chat_id_,true,
ramo..'mute_document'..arg.chat_id_,true,
ramo..'mute_keyboard'..arg.chat_id_,true,
ramo..'mute_game'..arg.chat_id_,true,
ramo..'mute_inline'..arg.chat_id_,true,
ramo..'lock_username'..arg.chat_id_,true,
ramo..'num_msg_max'..arg.chat_id_,5,
ramo..'lock_edit'..arg.chat_id_,true,
ramo..'replay'..arg.chat_id_,true,
ramo..'lock_rdodSource'..arg.chat_id_,true,
ramo.."lock_KickBan"..msg.chat_id_,true,
ramo.."lock_mmno3"..msg.chat_id_,true,
ramo.."lock_KickBan"..msg.chat_id_,true,
ramo.."lock_RandomRdod"..msg.chat_id_,true,
ramo.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(ramo..'group:ids',arg.chat_id_)
redis:sadd(ramo..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(ramo..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(ramo..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:sadd(ramo..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم تقييده بنجاح ✓")
end
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(ramo..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم فك تقييده بنجاح ")
end
if cmd == "setwhitelist" then
if redis:sismember(ramo..'whitelist:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مميز  في المجموعه ✓")
end
redis:hset(ramo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramo..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مميز  في المجموعه ✓")
end
if cmd == "remwhitelist" then
if not redis:sismember(ramo..'whitelist:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مميز  في المجموعه ✓")
end
redis:srem(ramo..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مميز  في المجموعه ✓")
end
if cmd == "setmnsha" then
if redis:sismember(ramo..':MONSHA_BOT:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ  في المجموعه ✓")
end
redis:hset(ramo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramo..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ  في المجموعه ✓")
end
if cmd == "remmnsha" then
if not redis:sismember(ramo..':MONSHA_BOT:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ  في المجموعه ")
end
redis:srem(ramo..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشى  في المجموعه ✓")
end

if cmd == "setowner" then
if redis:sismember(ramo..'owners:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مدير  في المجموعه ✓")
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(ramo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramo..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مدير  في المجموعه ✓")
end
if cmd == "remowner" then
if not redis:sismember(ramo..'owners:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مدير  في المجموعه ✓")
end
redis:srem(ramo..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله مدير  في المجموعه ✓")
end
if cmd == "promote" then
if redis:sismember(ramo..'admins:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه ادمن  في المجموعه ✓")
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(ramo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramo..'admins:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه ادمن  في المجموعه ✓")
end
if cmd == "demote" then
if not redis:sismember(ramo..'admins:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله ادمن  في المجموعه ✓")
end
redis:srem(ramo..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(ramo..':MONSHA_Group:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه منشئ اساسي  في المجموعه ✓")
end
redis:hset(ramo..'username:'..UserID,'username',USERNAME)
redis:sadd(ramo..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه منشئ اساسي  في المجموعه ✓")
end

if cmd == "Dwmonsh" then
if not redis:sismember(ramo..':MONSHA_Group:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله منشئ اساسي  في المجموعه ✓")
end
redis:srem(ramo..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم تنزيله منشئ اساسي  في المجموعه ✓")
end


if cmd == "UpMalk" then
if redis:sismember(ramo..':Malk_Group:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد رفعه مالك  في المجموعه ✓")
end
redis:hset(ramo..'username:'..UserID,'username',USERNAME)
redis:sadd(ramo..':Malk_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم رفعه مالك  في المجموعه ✓")
end

if cmd == "DwnMalk" then
if not redis:sismember(ramo..':Malk_Group:'..ChatID,UserID) then
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n- تم بالتاكيد تنزيله مالك  في المجموعه ✓")
end
redis:srem(ramo..':Malk_Group:'..ChatID,UserID)
...
redis:hset(ramo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramo..'banned:'..ChatID,UserID)
...
redis:hset(ramo..'username:'..UserID, 'username', Resolv)
redis:srem(ramo..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(ramo..'username:'..UserID, 'username', Resolv)
redis:sadd(ramo..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم كتمه  من المجموعه ✓")
end
...
redis:hset(ramo..'username:'..UserID, 'username', Resolv)
redis:srem(ramo..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"- المستخدم  ⋙「 "..NameUser.." 」 \n-  تم الغاء كتمه  من المجموعه ✓")
end

if cmd == "upMshrf" then
redis:hset(ramo..'username:'..UserID,'username',Resolv)
redis:setex(ramo..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(ramo..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then
local maseegs = redis:get(ramo..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(ramo..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(ramo..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end
...
.."\n- التعديل » "..(redis:get(ramo..'lock_edit'..msg.chat_id_) or 'false')
.."\n- الروابط » "..(redis:get(ramo..'lock_link'..msg.chat_id_) or 'false')
.."\n- التاك » "..(redis:get(ramo..'lock_tag'..msg.chat_id_) or 'false')
.."\n- المعرفات » "..(redis:get(ramo..'lock_username'..msg.chat_id_) or 'false')
.."\n\n- التكرار » "..(redis:get(ramo..'lock_flood'..msg.chat_id_) or 'false')
.."\n- الكلايش » "..(redis:get(ramo..'lock_spam'..msg.chat_id_) or 'false')
.."\n- الويب » "..(redis:get(ramo..'lock_webpage'..msg.chat_id_) or 'false')
.."\n- الماركدوان » "..(redis:get(ramo..'lock_markdown'..msg.chat_id_) or 'false')
.."\n- البوتات بالطرد » "..(redis:get(ramo..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n- البوتات » "..(redis:get(ramo..'lock_bots'..msg.chat_id_) or 'false')
.."\n- عدد التكرار » "..(redis:get(ramo..'num_msg_max'..msg.chat_id_) or 'false')
.."\n- وقت التنظيف » "..(redis:get(ramo..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n-` اعدادات الوسائط :`\n"
.."\n- المتحركه » "..(redis:get(ramo..'mute_gif'..msg.chat_id_) or 'false')
.."\n- الدردشه » "..(redis:get(ramo..'mute_text'..msg.chat_id_) or 'false')
.."\n- الانلاين » "..(redis:get(ramo..'mute_inline'..msg.chat_id_) or 'false')
.."\n- الالعاب » "..(redis:get(ramo..'mute_game'..msg.chat_id_) or 'false')
.."\n- الصور » "..(redis:get(ramo..'mute_photo'..msg.chat_id_) or 'false')
.."\n- الفيديو » "..(redis:get(ramo..'mute_video'..msg.chat_id_) or 'false')
.."\n- الصوت » "..(redis:get(ramo..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n- البصمات » "..(redis:get(ramo..'mute_voice'..msg.chat_id_) or 'false')
.."\n- الملصقات » "..(redis:get(ramo..'mute_sticker'..msg.chat_id_) or 'false')
.."\n- الجهات » "..(redis:get(ramo..'mute_contact'..msg.chat_id_) or 'false')
.."\n- التوجيه » "..(redis:get(ramo..'mute_forward'..msg.chat_id_) or 'false')
.."\n- الموقع » "..(redis:get(ramo..'mute_location'..msg.chat_id_) or 'false')
.."\n- الملفات » "..(redis:get(ramo..'mute_document'..msg.chat_id_) or 'false')
.."\n- الاشعارات » "..(redis:get(ramo..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n- الفشار » "..(redis:get(ramo..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n- الفارسيه » "..(redis:get(ramo..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n- الانكليزيه » "..(redis:get(ramo..'lock_lang'..msg.chat_id_) or 'false')
.."\n- الاضافه » "..(redis:get(ramo..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n-` اعدادات اخرى : `"
.."\n- الترحيب » "..(redis:get(ramo..'welcome:get'..msg.chat_id_) or 'false')
.."\n-  الردود » "..(redis:get(ramo..'replay'..msg.chat_id_) or 'false')
.."\n-  الردود العشوائيه » "..(redis:get(ramo.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n-  التحذير » "..(redis:get(ramo..'lock_woring'..msg.chat_id_) or 'false')
.."\n- الايدي » "..(redis:get(ramo..'lock_id'..msg.chat_id_) or 'false')
.."\n- الرابط » "..(redis:get(ramo..'lock_linkk'..msg.chat_id_) or 'false')
.."\n- المغادره » "..(redis:get(ramo..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n- الحظر » "..(redis:get(ramo..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n- الحمايه » "..(redis:get(ramo..'antiedit'..msg.chat_id_) or 'false')
.."\n- التاك للكل » "..(redis:get(ramo..'lock_takkl'..msg.chat_id_) or 'false')
.."\n- الايدي بالصوره » "..(redis:get(ramo..'idphoto'..msg.chat_id_) or 'false')
.."\n- التحقق » "..(redis:get(ramo.."lock_check"..msg.chat_id_) or 'false')
.."\n- التنظيف التلقائي » "..(redis:get(ramo.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n- ردود السورس » "..(redis:get(ramo.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n- عدد التكرار » "..(redis:get(ramo..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n-` اعدادات التقـييد :`\n"
.."\n- التقييد بالتوجيه » "..(redis:get(ramo..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n- التقييد بالصور » "..(redis:get(ramo..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n- التقييد بالروابط » "..(redis:get(ramo..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n- التقييد بالمتحركه » "..(redis:get(ramo..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n- التقييد الفيديو » "..(redis:get(ramo..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n- الملفات » "..(redis:get(ramo..'mute_document'..msg.chat_id_) or 'false')
.."\n- الاشعارات » "..(redis:get(ramo..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n- الكيبورد » "..(redis:get(ramo..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
